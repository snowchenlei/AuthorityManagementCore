...
namespace Snow.AuthorityManagement.Common.Extensions
{
    public static class DistributedCacheExtensions
    {
        ...
        {
            await cache.SetAsync(key, Encoding.UTF8.GetBytes(Serialization.SerializeObject(value)));
        }
        ...
        {
            await cache.SetAsync(key, encoding.GetBytes(Serialization.SerializeObject(value)));
        }
        ...
        {
            return Serialization.DeserializeObject<TEntity>(await cache.GetStringAsync(key));
        }
    }
}