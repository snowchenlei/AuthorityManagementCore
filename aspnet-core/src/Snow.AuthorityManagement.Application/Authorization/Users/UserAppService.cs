...
namespace Snow.AuthorityManagement.Application.Authorization.Users
{
    public partial class UserAppService : IUserAppService
    {
        ...
        public async Task<IEnumerable<RoleSelectDto>> GetUserRoleSelectAsync(int? userId)
        {
        ...
        /// <param name="userId">用户编号</param>
        /// <returns></returns>
        public async Task<GetUserForEditOutput> GetUserInfoForEditAsync(int? userId)
        {
