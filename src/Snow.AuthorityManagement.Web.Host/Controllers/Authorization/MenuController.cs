...
namespace Snow.AuthorityManagement.Web.Core.Controllers.Authorization
{
    ...
    public class MenuController : PageController
    {
        ...
        [AncAuthorize(PermissionNames.Pages_Menus_Query)]
        ...
        [AncAuthorize(PermissionNames.Pages_Menus_Create)]
        ...
        [ProducesResponseType(400)]
        [AncAuthorize(PermissionNames.Pages_Menus_Edit)]
        ...
        [ProducesResponseType(204)]
        [ProducesResponseType(404)]
        [AncAuthorize(PermissionNames.Pages_Menus_Delete)]
