...
namespace Anc.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Removes first occurrence of the given postfixes from end of the given string. Ordering is
        /// important. If one of the postFixes is matched, others will not be tested.
        /// </summary>
        ...
        /// <summary>
        /// Gets a substring of a string from beginning of the string if it exceeds maximum length.
        /// It adds a "..." postfix to end of the string if it's truncated. Returning string can not
        /// be longer than maxLength.
        /// </summary>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="str"/> is null</exception>
