...
namespace Anc.Authorization.Permissions
{
    public class PermissionDefinition
    {
        ...
        /// <summary>
        /// Parent of this permission if one exists. If set, this permission can be granted only if
        /// parent is granted.
        /// </summary>
        public PermissionDefinition Parent { get; private set; }

        /// <summary>
        /// A list of allowed providers to get/set value of this permission. An empty list indicates
        /// that all providers are allowed.
        /// </summary>
        ...
        /// <summary>
        /// Sets a property in the <see cref="Properties"/> dictionary. This is a shortcut for nested
