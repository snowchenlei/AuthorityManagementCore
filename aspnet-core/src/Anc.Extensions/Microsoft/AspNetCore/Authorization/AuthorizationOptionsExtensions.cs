...
namespace Microsoft.AspNetCore.Authorization
{
    public static class AuthorizationOptionsExtensions
    {
        ...
        /// Gets all policies.
        ///
        /// IMPORTANT NOTE: Use this method carefully. It relies on reflection to get all policies
        /// from a private field of the <see cref="options"/>. This method may be removed in the
        /// future if internals of <see cref="AuthorizationOptions"/> changes.
        /// </summary>
