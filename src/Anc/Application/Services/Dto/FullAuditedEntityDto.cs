...
{
    /// <summary>
    /// A shortcut of <see cref="FullAuditedEntityDto{TPrimaryKey}"/> for most used primary key type
    /// ( <see cref="int"/>).
    /// </summary>
    [Serializable]
    ...
    /// <summary>
    /// This class can be inherited for simple Dto objects those are used for entities implement <see
    /// cref="IFullAudited{TUser}"/> interface.
    /// </summary>
